...
<section id="bep" class="py-12 md:py-20 px-4 bg-gray-50 dark:bg-gray-800 animate-section">
	<div class="container mx-auto max-w-5xl">
		...
		<div class="text-center mb-10 md:mb-14">
			<span class="inline-block bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 text-sm font-semibold px-4 py-1 rounded-full mb-4">
				📄 Dokumen Resmi
			</span>
		...
		<!-- Card Utama -->
		<div class="bg-white dark:bg-gray-900 rounded-2xl md:rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
			<div class="flex flex-col md:flex-row">

				<!-- Ikon / Visual -->
				<div class="gradient-bg flex items-center justify-center p-10 md:p-14 md:w-1/3">
					<div class="text-center text-white">
						<div class="text-7xl mb-4">📋</div>
						<p class="text-lg font-bold">Dokumen BEP</p>
						<p class="text-blue-200 text-sm mt-1">Format PDF</p>
					</div>
				</div>
				...
				<div class="p-6 md:p-10 flex flex-col justify-between md:w-2/3">
					...
					<div class="flex flex-col sm:flex-row gap-3">
						<a
							href="assets/file/BEP.pdf"
							download
							id="btn-download-bep"
							class="inline-flex items-center justify-center gap-2 gradient-bg text-white font-semibold px-6 py-3 rounded-xl hover:opacity-90 hover:shadow-lg transition-all duration-200"
							data-gtm-cta="download_bep">
							<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
								<path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a2 2 0 002 2h12a2 2 0 002-2v-1M12 12v6m0 0l-3-3m3 3l3-3M12 3a9 9 0 100 18A9 9 0 0012 3z" />
							</svg>
							Unduh Dokumen BEP
						</a>
						<button
							type="button"
							id="btn-preview-bep"
							onclick="window.open('assets/file/BEP.pdf', '_blank', 'noopener,noreferrer')"
							class="inline-flex items-center justify-center gap-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold px-6 py-3 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-200 cursor-pointer"
							data-gtm-cta="preview_bep">
							<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
		...
		<p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
			📌 Dokumen tersedia dalam format <strong>PDF</strong> dan dapat diunduh secara gratis tanpa registrasi.
		</p>
