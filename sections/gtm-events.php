<script>
	(function() {
		// ============================================================
		// GTM DataLayer Event Tracking - Sewa Hiace Tuban
		...
		// ============================================================
		// 3. Estimation Section View Tracking (Intersection Observer)
		// ============================================================
		function setupPricingViewTracking() {
			const pricingSection = document.getElementById('estimasi');
				...
				entries.forEach(function(entry) {
					if (entry.isIntersecting && !tracked) {
						...
						window.dataLayer.push({
							...
							event_label: 'Estimate Section Viewed'
						});
						observer.disconnect();
					}
				});
